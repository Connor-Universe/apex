                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="card-title">Referal Link: </h4> <input class= "form-control" id="input" type="text" value ="https://apexinvestments.ltd/register.php?r=<?php echo"$referal_code";?>" disabled><button class="btn btn-primary" id="clipboardCopy">Copy</button>
