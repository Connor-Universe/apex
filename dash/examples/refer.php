        ...
        <div class="row">
          <div class="col-lg-12">
            <h3>Referal Link</h3>
                ...
                <div class="card-body">
                  <input type= "text" value="https://apexinvestments.ltd/register.php?r=<?php echo "$promo";?>" class="form-control" id="input" disabled> <button id="clipboardCopy" class="btn btn-primary">Copy</button>
